...
summary: In this paper, we present two novel training paradigms on how to train generative models on statistical data accessible in real-world experiments, to generate fine-grained particle information, which do not exist in measurement.
